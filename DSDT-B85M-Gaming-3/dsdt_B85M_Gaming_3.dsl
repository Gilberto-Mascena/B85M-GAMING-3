 ...
 *
 * Disassembly of dsdt.aml, Sun Jan  1 18:50:02 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C4C1 (50369)
 *     Revision         0x02
 *     Checksum         0xA0
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDA8DAC18, 0x02B2)
                ...
                Device (HS12)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            ...
                            {
                                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                /* 0008 */  0x71, 0x0C, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00   // q.......
                            }
                        })
                        CreateBitField (DerefOf (PLDP [Zero]), 0x40, VIS)
                        If (!(PR2S (0x0C) & PR2))
                ...
                Device (HS15)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            ...
                            {
                                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                                /* 0008 */  0x71, 0x0C, 0x80, 0x07, 0x00, 0x00, 0x00, 0x00   // q.......
                            }
                        })
                        CreateBitField (DerefOf (PLDP [Zero]), 0x40, VIS)
                        If (!(PR2S (0x0F) & PR2))
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDA7DBE18, 0x10)
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xDA8C6018, 0x00C4)
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0xDA8C4018, 0x0020)
                ...
                If ((Arg0 == 0x05))
                {
                    ...
                    VP05 [Zero] = Zero
                    VP05 [One] = BF05 /* \_SB_.PTMD.GDSV.BF05 */
                    Return (VP05) /* \_SB_.PTMD.GDSV.VP05 */
                }
